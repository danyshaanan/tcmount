...
function checkForTrueCrypt() {
  exec('type truecrypt', function(err, stdout, stderr) { //TODO: This should be 'which truecrypt', change and test
    if (err) {
      console.log(clc.red('You do not seem to have truecrypt available im the command line!'));
